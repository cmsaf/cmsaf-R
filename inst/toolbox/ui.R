# the CM SAF R Toolbox. It will be started by the R-script CMSAF-R-TOOLBOX.R
#
# You should not use this R-script on its own!
#
# Have fun with the CM SAF R TOOLBOX!
#                                              (Steffen Kothe / CM SAF 2019-01-25)
#__________________________________________________________________________________
descriptionString <-
"

The CM SAF R TOOLBOX 2.0.0 -- 'Don`t Panic'
...
visualizeString <-
  "<h2>Visualize</h2>
<p>Please select a NetCDF file <strong>(.nc)</strong> to start the visualization process.</p>
<br>
      ...
      mainPanel(tabsetPanel(tabPanel("Plot",
                                     tags$div(id = "plots_div",
                                              ...
                                              shinyjs::hidden(tags$div(id = "spinner_plot1",
                                                                       h3("Rendering plot..."))))),
                            tabPanel("Statistics",
                                     tags$div(id = "statistics_1d",
                                              h4("This page is only available for spatial map plots.")),
                                     tags$div(id = "statistics_2d",
