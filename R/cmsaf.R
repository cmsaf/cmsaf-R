...
#'
#'  Schulz, J., W. Thomas, R. Mueller, H.-D. Behr, D. Caprion, H. Deneke, S.
#'  Dewitte, B. Duerr, P. Fuchs, A. Gratzki, R. Hollmann, K.-G. Karlsson, T.
#'  Manninen, M. Reuter, A. Riihela, R. Roebeling, N. Selbach, A. Tetzlaff, E.
#'  Wolters, A. Zelenka, M. Werscheck, 2008: Operational climate monitoring from
#'  space: the EUMETSAT satellite application facility on climate monitoring (CM
#'  SAF), Atmos. Chem. Phys. Discuss., 8, 8517-8563, 2008, SRef-ID:
#'  1680-7375/acpd/2008-8-8517
#'
