...
#'
#'unlink(c("CMSAF_example_file.nc", "CMSAF_example_file_extract.level1.nc",
#'  "CMSAF_example_file_extract.level2.nc"))
extract.level <- function(var, infile, outfile, level = 1, nc34 = 3,
