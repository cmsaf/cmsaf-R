...
#'only merged. All input files have to have the same rectangular grid and the
#'same variable. The reference time of the output file is determined by the
#'first input file.
#'
...
box_mergetime <- function(var, path, pattern, outfile, lon1 = -180, lon2 = 180,
                          lat1 = -90, lat2 = 90, level = NULL, nc34 = 3,
